...
export class ReactivityWeek extends Component {
  ...
  constructor(props) {
    ...
    this.isMonthStart = props.startDate.day ===1 || props.startDate.day > this.endDate.day
  ...
  logDates() {
    console.log(this.props.startDate.toISO(), this.endDate.toISO(), this.props.data)
  }
